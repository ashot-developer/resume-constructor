<div class="for_dompdf resume_block">
    <div class="modern_img_name">
        <div class="modern_resume_img">
        ...
        <div class="user_name modern_user_name">
    ...
    <div class="modern_resume_inf">
        <ul>
            ...
            <li class="moder_li"><img src="/wp-content/plugins/constructor-resume/assets/img/done.png" alt=""><?= $allResumeInfo['basic_info']['employment'] ?? 'Не указано' ?></li>
            <li class="moder_li"><img src="/wp-content/plugins/constructor-resume/assets/img/done.png" alt=""><?= $allResumeInfo['basic_info']['schedule'] ?? 'Не указано' ?></li>
            ...
            <?php if ($allResumeInfo['lang_computer_skills']['computer_skills']['0'] != '') : ?>
                <li class="moder_li">
                    <?php foreach ($allResumeInfo['lang_computer_skills']['computer_skills'] as $scils) : ?>
                        <?php if ($scils != '') : ?>
                            <p class="el"><img src="/wp-content/plugins/constructor-resume/assets/img/done.png" alt=""><?= $scils; ?></p>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </li>
            <?php else : ?>
